...
const Sidebar = ({ menuInfo, setMenuInfo }) => {
	...
	const sendEmail = async (e) => {
		...
		try {
			...
			setStatusMessage(
				"You are now subscribed! You will receive future updates and promotions."
			);
	...
	return (
		<>
			...
			>
				...
				{/* Content */}
				<div className="p-6 text-gray-300 space-y-16">
					{/* About */}
					<p className="leading-relaxed">
						Lorem ipsum dolor sit amet consectetur adipisicing elit.
						Doloribus exercitationem deleniti aliquid velit quaerat
						ut dolorem quae sed quo corrupti!
					</p>
